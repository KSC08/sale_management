...
<div class="row">
    <div class="col-12 col-xl-12">
        ...
        <div class="card">
                ...
                <h1 class="text-primary mr-auto" align="center">เพิ่มข้อมูลลูกค้า</h1>
                </div>
                    <div class="card-body">
                ...
                @endif
                <form method="POST" action="/customer_store" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{ method_field('POST') }}
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label style="color:red;">ชื่อ *</label>
                            <input type="text" name="fname" class="form-control" placeholder="ป้อนชื่อ" value="{{$custome
                            rs->cus_name}}" required>
                        </div>
                        <div class="form-group col-md-5">
                            <label style="color:red;">หน่วยงาน *</label>
                            <select class="custom-select " name="company_id" id="comid">
                                <option value="{{$customers->com_id}}">{{$customers->cus_name}}</option>
                    ...
                    <div class="form-row">
                        ...
                        <center>
                            <div class="form-group"><input type="submit" class="btn btn-primary" value="บันทึกข้อมูลแล้วหยุด">
                                <a href="{{url('/customer')}}" class="btn btn-danger">ย้อนกลับ</a>
                            </div>
                        </center>    
                        </div>
                    </div>
