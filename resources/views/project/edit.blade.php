    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url('/project_update',$project->pro_id) }}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{ method_field('POST') }}
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="status" name="status" class="form-control" required>
                                    <option  value="{{$project->status_id}}" selected>{{$project->status_name}}</option>
                                    @foreach ($project_status as $data)
                                    <?php if($project->status_id!=$data->id){ ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="type" name="type" class="form-control" onchange="rolechang();" required>
                                    <option value="{{$project->type_id}}" selected>{{$project->type_name}}</option>
                                    @foreach ($project_type as $data)
                                    <?php if($project->type_id!=$data->id){ ?>
                                    <option value="{{ $data->id }}">{{ $data->name }}</option>
                                    <?php }?>
                                    @endforeach
                                </select>
                        ...
                        <div class="row" id="type_else_div" style="display:none">
                            <div class="mb-3">
                                <textarea class="form-control" placeholder="กรุณาระบุ..................." rows="3" name="type_else">{{$project->type_else}}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
                                <label for="detail">งบประมาณ</label>
                                <input type="text" class="form-control" placeholder="กรอกงบประมาณ" rows="1" id="detail" value="{{$project->budget}}" name="budget" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
                                <label for="detail">รายละเอียด</label>
                                <textarea class="form-control" placeholder="Textarea" rows="1" id="detail" value="{{$project->detail}}" name="detail" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" id="pmname" name="pmname" value="{{$project->pmname}}" placeholder="กรอกชื่อผู้ดูแลโครงการ" required>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label for="pmlname">นามสกุล(ทีมเทคนิคที่ดูแลโครงการ) </label>

                                <input type="text" class="form-control" id="pmlname" name="pmlname" value="{{$project->pmlname}}" placeholder="กรอกนามสกุลผู้ดูแลโครงการ" required>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label for="pmphone">เบอร์โทร</label>

                                <input type="text" class="form-control" id="pmphone" name="pmphone" value="{{$project->pmphone}}" placeholder="กรอกเบอร์โทรผู้ติดต่อโครงการ" required>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <select id="inputState" class="form-control" name="customer" required>
                                    <option value="{{$project->cus_id}}" selected>{{$project->cus_name}}</option>
                                    @foreach($customers as $data => $value)
                                    <?php if($project->cus_id!=$value->id){ ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <label class="form-check">
                                        <input name="Payment" type="radio" class="form-check-input" checked value="รายงวด" <?php if($project->Payment=='รายงวด'){ ?>checked="checked" <?php } ?>>
                                        <span class="form-check-label">รายงวด</span>
                                    </label>
                                </div>
                                <div class="col-sm-3">
                                    <label class="form-check">
                                        <input name="Payment" type="radio" class="form-check-input" value="รายเดือน"<?php if($project->Payment=='รายเดือน'){ ?>checked="checked" <?php } ?>>
                                        <span class="form-check-label">รายเดือน</span>
                                    </label>
                                </div>
                                <div class="col-sm-3">
                                    <label class="form-check">
                                        <input name="Payment" type="radio" class="form-check-input" value="ครั้งเดียว"<?php if($project->Payment=='ครั้งเดียว'){ ?>checked="checked" <?php } ?>>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="operational_goals">{{$project->operational_goals}}</textarea>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail1">{{$project->scope_detail1}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail2">{{$project->scope_detail2}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail3">{{$project->scope_detail3}}</textarea>
                                            <label class="col-form-label">3.3.2.ประมาณการค่าปรับ (ระบุจำนวน)
                                            </label>
                                            <label class="col-form-label">1. ค่าปรับจากการส่งมอบ </label>

                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail4">{{$project->scope_detail4}}</textarea>

                                            <label class="col-form-label">2. ประมาณการค่าปรับตาม SLA
                                                หากไม่มีค่าปรับให้ระบุเหตุผล </label>
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail5">{{$project->scope_detail5}}</textarea>
                                            <label class="col-form-label">3.3.3.กรณีมีค่าปรับจากปีก่อนหน้า
                                                กรุณาระบุจำนวน และสาเหตุ</label>
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="scope_detail6">{{$project->scope_detail6}}</textarea>
                            ...
                            <div class="col-12 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="action_plan1">{{$project->action_plan1}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            <div class="mb-3 col-xl-6">
                                                ...
                                                <input type="date" class="form-control" id="date_start" name="action_plan_date2" value="{{$project->action_plan_date2}}">
                                            </div>
                                            <div class="mb-3 col-xl-6">
                                                <label for="date_start">วันที่สิ้นสุด</label>
                                                <input type="date" class="form-control" id="date_start" name="action_plan_date3" value="{{$project->action_plan_date3}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="action_plan4">{{$project->action_plan4}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="action_plan5">{{$project->action_plan5}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="action_plan6">{{$project->action_plan6}}</textarea>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="finance1">{{$project->finance1}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="finance2">{{$project->finance2}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="finance3">{{$project->finance3}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="finance4">{{$project->finance4}}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="finance5">{{$project->finance5}}</textarea>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="performance1">{{$project->performance1}}</textarea>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-form-label">6.2. ผลตอบแทนที่ไม่เป็นตัวเงิน </label>
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="performance2">{{$project->performance2}}</textarea>
                                        </div>
                                        <div class="mb-3 row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <textarea class="form-control" placeholder="กรอกรายละเอียด" rows="3" name="Risk">{{$project->Risk}}</textarea>
                                        </div>
                                        <div class="mb-3 row">
